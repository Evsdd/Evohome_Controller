...
ComPort.timeout = 60              # Read timeout = 1sec
...
Zone_INFO = [
             ['04:087482','Zone1','','8.5','',''],
             ['04:124015','Zone2','','11.3','','']
             ]                    

Zone_num = 2                      # Number of zones 

Device_count = 2                  # Count of devices successfully bound
...
for i in xrange(0,Zone_num):
   ...
   print('Zone %d:(%s):(%s):(%s:%s)' % (i+1,Zone_INFO[i][0],Zone_INFO[i][1],Zone_INFO[i][3],Zone_INFO[i][4]))
